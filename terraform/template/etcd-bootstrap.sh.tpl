...
add-apt-repository ppa:ansible/ansible && apt-get update && apt-get -y install python-pip awscli unzip
...
/usr/bin/ansible-playbook /var/lib/bootstrap/bootstrap_etcd.yaml
